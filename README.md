...
## Features
- **Hardware Interception**: The app securely intercepts raw HID KeyEvent inputs securely in the foreground without requiring accessible services permissions.
...
- **Minimalist Jetpack Compose UI**: Provides high contrast visual indicators in bold colors (#000000 black background and vivid yellow/texts). Utilizes `BoxWithConstraints` to scale text and implements battery saving/KeepScreenOn logic.
