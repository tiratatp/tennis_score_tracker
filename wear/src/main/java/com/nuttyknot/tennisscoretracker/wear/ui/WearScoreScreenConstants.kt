...
internal val SCORE_FONT_SIZE = 40.sp
internal val DETAIL_FONT_SIZE = 14.sp
internal val LABEL_FONT_SIZE = 12.sp
internal val SCREEN_PADDING = 8.dp
...
internal const val NAME_MAX_WIDTH_FRACTION = 0.3f
