...
// Ambient mode screenshots on square watch (Galaxy Watch 7)
class WearAmbientScreenshotTest {
    companion object {
        ...
        // Galaxy Watch 7 (44mm): 480x480 px, ~327 PPI, square
    ...
    fun ambientInMatch() {
        ...
        paparazzi.snapshot("ambientInMatch") {
            WearTheme {
                WearScoreScreen(
                    scoreDisplay = score,
                    isConnected = true,
    ...
    fun ambientMatchOver() {
        ...
        paparazzi.snapshot("ambientMatchOver") {
            WearTheme {
                WearScoreScreen(
                    scoreDisplay = score,
                    isConnected = true,
